...
## Load data --------------------------------------
cell_data_tbl <- read.csv('G:/TLSdata/TLS_total_data/Processing data/subset/B_Plasma/B_Plasma_for_seurat_metadata.csv', header = TRUE)
...
cell_type_order <- c("B_IGHM_04", "B_CD74_1_00", "B_CD69_1_01", 
                     "B_GC_11", "B_ISG_08", "B_MHC_II_05",
                     "Cycling_B_plamsa_cell_09", "Plasma_cell_02_03",
                     "Plasma_cell_01_02")
