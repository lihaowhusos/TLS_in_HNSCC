...
# Save images
ggsave("XXX/enrichment_UMAP/T_NK_mature_new.pdf", plot = plot_umap(contrast_mature, "mature"), width = 6, height = 5)
ggsave("XXX/enrichment_UMAP/T_NK_immature_new.pdf", plot = plot_umap(contrast_immature, "immature"), width = 6, height = 5)
ggsave("XXX/enrichment_UMAP/T_NK_none_new.pdf", plot = plot_umap(contrast_none, "none"), width = 6, height = 5)
