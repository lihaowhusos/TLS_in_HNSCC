...
####delete szj107849
#n <- nchar("szj107849") 
#table <- table[!(substr(rownames(table), 1, n) == "szj107849"), ]
...
########### save figure ################
getwd()
ggsave("G:/TLSdata/TLS_total_data/figures/enrichment_UMAP/T_NK_mature_new.pdf",plot = kernel_umap_m,width = 6, height = 5)
ggsave("G:/TLSdata/TLS_total_data/figures/enrichment_UMAP/T_NK_immature_new.pdf",plot = kernel_umap_im,width = 6, height = 5)
ggsave("G:/TLSdata/TLS_total_data/figures/enrichment_UMAP/T_NK_none_new.pdf",plot = kernel_umap_n,width = 6, height = 5)
