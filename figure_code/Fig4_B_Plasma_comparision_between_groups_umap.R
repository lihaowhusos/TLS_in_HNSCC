...
kernel_density_contrast <- function(data, group_var, subset_a, subset_b, grid_points = 200, bandwidth = 0.2, quench_factor = 0.025) {
...
# Load data
load("XXX/B_Plasma_after_seurat.Rdata")
...
# Save images
ggsave("XXX/enrichment_UMAP/B_Plasma_mature_new.pdf", plot = plot_umap(contrast_mature, "mature"), width = 6, height = 5)
ggsave("XXX/enrichment_UMAP/B_Plasma_immature_new.pdf", plot = plot_umap(contrast_immature, "immature"), width = 6, height = 5)
ggsave("XXX/enrichment_UMAP/B_Plasma_none_new.pdf", plot = plot_umap(contrast_none, "none"), width = 6, height = 5)