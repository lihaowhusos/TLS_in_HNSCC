...
kde2d_contrast <- function(data_tbl, kernel_group, kernel_subsets_a, kernel_subsets_b, 
                           n = 200, h = 0.2, quench = 0.025) { #################change quench
...
ggsave("G:/TLSdata/TLS_total_data/figures/B/B_Plasma_mature.pdf",plot = kernel_umap_m,width = 6, height = 5)
ggsave("G:/TLSdata/TLS_total_data/figures/B/B_Plasma_immature.pdf",plot = kernel_umap_im,width = 6, height = 5)
ggsave("G:/TLSdata/TLS_total_data/figures/B/B_Plasma_none.pdf",plot = kernel_umap_n,width = 6, height = 5)
