...
scrna_cell_tbl <- read.csv('G:/TLSdata/spatial/table/spatial_obs_for_R.csv',header = TRUE)
...
ggsave("G:/TLSdata/TLS_total_data/figures/dotplot_hotmap/TLS_score_dot_plot.pdf",plot = p1)
...
ggsave("G:/TLSdata/TLS_total_data/figures/dotplot_hotmap/TLS_12_sig_plot.pdf",plot = p2)
