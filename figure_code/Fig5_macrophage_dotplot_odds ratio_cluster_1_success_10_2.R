...
## load data --------------------------------------
scrna_cell_tbl <- read.csv('G:/TLSdata/TLS_total_data/Processing data/subset/Myeloid/Myeloid_for_seurat_metadata.csv',header = TRUE)
...
ggsave("G:/TLSdata/TLS_total_data/figures/dotplot_hotmap/Myeloid_cluster_dot_plot.pdf",plot = p_scrna_odds_ratio, width = 7)
