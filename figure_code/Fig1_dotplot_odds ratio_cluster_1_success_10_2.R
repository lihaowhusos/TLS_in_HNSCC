...
####### re-group #################
## B Cancer_cell Endothelial_cell Fibroblast Lymphatic_endothelial_cell Mast_cell Myeloid_cell Neutrophil Pericytes Plasma_cell T_NK
custom_order <- c("T_NK", 
                  "B", 
                  "Plasma_cell",
                  "Myeloid_cell",
...
ggsave("G:/TLSdata/TLS_total_data/figures/dotplot_hotmap/cluster_1_dot_plot.pdf",plot = p_scrna_odds_ratio)
